    ...
    <div className="app-shell">
      <aside className={`sidebar ${menuOpen ? "open" : ""}`}>
        ...
        <nav>
          ...
          <Link className="document-link" href="/painel/apoiadores"><UserPlus size={18} /><span>Painel de apoiadores</span><ArrowRight className="nav-arrow" size={15} /></Link>
          <Link className="document-link" href="/obras"><BadgeCheck size={18} /><span>Obras e antes/depois</span><ArrowRight className="nav-arrow" size={15} /></Link>
